...
import (
	...
	"github.com/Kaname87/blueprint/chap2/trace"
	"github.com/gorilla/websocket"
	"github.com/stretchr/objx"
)

type room struct {
	// forward is channel that holds incoming messages
	// that should be forwardesd to the other clients
